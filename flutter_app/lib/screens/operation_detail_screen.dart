      ...
      builder: (ctx, provider, _) {
        ...
        return Scaffold(
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text('목차 (TOC)', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700, color: cs.onSurface)),
                  ),
                  ...
                  Expanded(
                    child: ListView.builder(
                      ...
                      itemBuilder: (_, i) {
                        ...
                        return ListTile(
                          leading: Icon(s.icon, size: 20, color: cs.primary),
                          title: Text(s.title, style: TextStyle(fontSize: 14, color: cs.onSurface)),
                          trailing: isEdited ? Icon(Icons.edit_note_rounded, size: 16, color: cs.primary) : null,
            ...
            itemBuilder: (_, i) {
              ...
              return Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: isEdited ? cs.primary.withValues(alpha: 0.4) : cs.outlineVariant),
                ),
                child: Theme(
                  ...
                  child: ExpansionTile(
                    ...
                    leading: Container(
                      ...
                      child: Icon(s.icon, size: 18, color: cs.primary),
                    ),
                    title: Row(children: [
                      Expanded(child: Text(s.title, style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600, color: cs.onSurface))),
                      if (isEdited) Icon(Icons.edit_note_rounded, size: 16, color: cs.primary),
                    ]),
                    children: [
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(mainAxisAlignment: MainAxisAlignment.end, children: [
                              InkWell(
                                onTap: () => _showSectionEditDialog(s.key, s.title, s.content, provider, cs),
                                ...
                                child: Container(
                                  ...
                                  child: Row(mainAxisSize: MainAxisSize.min, children: [
                                    ...
                                    Text('편집', style: TextStyle(fontSize: 11, fontWeight: FontWeight.w600, color: cs.primary)),
                                  ]),
                                ),
                              ),
                              InkWell(
                                onTap: () {
                                  ...
                                  _showSnack('${s.title} 섹션이 복사되었습니다');
                                },
                                borderRadius: BorderRadius.circular(6),
                                child: Container(
                                  padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
                                  child: Row(mainAxisSize: MainAxisSize.min, children: [
                                    Icon(Icons.content_copy_rounded, size: 14, color: cs.onSurface.withValues(alpha: 0.5)),
                                    const SizedBox(width: 4),
                                    Text('복사', style: TextStyle(fontSize: 11, fontWeight: FontWeight.w600, color: cs.onSurface.withValues(alpha: 0.5))),
                                  ]),
                                ),
                              ),
                            ]),
          ...
          floatingActionButton: FloatingActionButton.small(
            ...
            tooltip: '목차',
            child: const Icon(Icons.toc_rounded, size: 20),
          ),
        );
      },
    );
        ...
        return Padding(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            SizedBox(width: double.infinity, child: ElevatedButton(
              onPressed: () {
                provider.updateOperationSection(key, ctrl.text);
                Navigator.pop(ctx);
                _showSnack('$title 섹션이 수정되었습니다');
              },
              child: const Text('저장'),
            )),
          ]),
